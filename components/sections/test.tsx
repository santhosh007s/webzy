...
const TestimonialsSection: React.FC = () => {
  ...
  const TestimonialCard: React.FC<TestimonialCardProps> = ({ testimonial }) => (
    <div
      className="rounded-2xl p-4 md:p-6 border border-gray-600/30 hover:border-gray-500/50 transition-colors cursor-pointer min-w-[280px] md:min-w-[320px] mr-4 flex-shrink-0"
  ...
  const ScrollingRow: React.FC<ScrollingRowProps> = ({ testimonials, direction = "left", speed = 50 }) => {
    ...
    const cardWidth = 336; // 320px card + 16px margin
    const totalWidth = testimonials.length * cardWidth;
    
    // Create optimized duplicates for seamless scrolling
    ...
    // For right-moving row, handle seamless loop with reset and proper hover/resume
    React.useEffect(() => {
    ...
    // For left-moving row, keep previous logic
    React.useEffect(() => {
    ...
    const handleMouseLeave = async () => {
      ...
      } // for right, useEffect will handle resume
    };
      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        <div className="text-center mb-8 md:mb-16">
          <motion.h1
            ...
            className="text-3xl md:text-5xl lg:text-6xl font-bold leading-tight px-4"
          >
        ...
        <div className="space-y-4 md:space-y-6">
          {/* Row 1 - Moving Left */}
          <ScrollingRow testimonials={row1Testimonials} direction="left" speed={30} />
          
          {/* Row 2 - Moving Right */}
          <ScrollingRow testimonials={row2Testimonials} direction="right" speed={18} />
          
          {/* Row 3 - Moving Left */}
          <ScrollingRow testimonials={row3Testimonials} direction="left" speed={30} />
        </div>
      </div>
    </div>
  );
